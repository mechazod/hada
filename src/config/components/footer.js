...
const footerData = {
  ...
  socialLinks: [
    ...
    { ariaLabel: 'Github', icon: 'tabler:brand-github', href: 'https://github.com/mechazod/hada' },
  ],

  // The footnote to be displayed in the footer (can contain HTML)
  footNote: `
    <span class="w-5 h-5 md:w-6 md:h-6 md:-mt-0.5 bg-cover mr-1.5 float-left rounded-sm bg-[url(https://onwidget.com/favicon/favicon-32x32.png)]"></span>
    Made by <a class="text-blue-600 hover:underline dark:text-gray-200" href="https://github.com/mechazod"> Mechazod</a> and <a class="text-blue-600 hover:underline dark:text-gray-200" href="https://onwidget.com/"> onWidget</a> · All rights reserved.
  `,
};
